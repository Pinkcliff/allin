...
import os
# 添加动捕模块路径
motion_capture_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'modules', 'motion_capture')
...
class GlobalDashboardWindow(QMainWindow):
    ...
    def setup_ui(self):
        self.canvas = BackgroundWidget("../assets/images/背景.png", 0.5)
